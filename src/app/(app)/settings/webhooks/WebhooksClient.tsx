    ...
    <div className="max-w-4xl mx-auto">
      ...
      {newSecret && (
        <div className="bg-green-500/10 border border-green-500/30 rounded-2xl p-6 mb-6">
          ...
          <button
            ...
            className="mt-3 text-gray-500 hover:text-[#D4AF37] text-sm transition-colors"
          >
            Dismiss
          </button>
        </div>
      ...
      {loading ? (
        ...
        <div className="bg-[#141414] border border-white/[0.08] rounded-2xl p-12 text-center">
          <div className="w-14 h-14 rounded-2xl bg-[#D4AF37]/10 border border-[#D4AF37]/20 flex items-center justify-center mx-auto mb-4">
            <Webhook size={24} className="text-[#D4AF37]" />
          </div>
      ...
      <div className="mt-8 bg-[#141414] border border-white/[0.08] rounded-2xl p-6">
        ...
        <p className="text-gray-400 text-sm mb-4">
          ...
          <code className="text-[#D4AF37] bg-[#D4AF37]/10 px-1.5 py-0.5 rounded text-xs">X-ForjeGames-Signature</code>{' '}
