...
export const metadata: Metadata = {
  title: 'Template Not Found | ForjeGames',
  description: 'This marketplace template could not be found.',
      ...
      <div className="relative max-w-md w-full text-center">
        <div className="relative bg-white/[0.025] border border-white/[0.07] rounded-2xl p-10 shadow-2xl backdrop-blur-sm">
          ...
          <div className="mx-auto mb-7 relative w-20 h-20">
            ...
            >
              <FileQuestion className="w-9 h-9" style={{ color: '#D4AF37' }} strokeWidth={1.5} />
            </div>
          </div>

          <h1 className="text-3xl font-bold text-white mb-3 tracking-tight">Template Not Found</h1>
          <p className="text-gray-400 text-sm mb-8 max-w-sm mx-auto leading-relaxed">
            This template doesn&apos;t exist or may have been removed from the marketplace.
          </p>

          <Link
            href="/marketplace"
            className="inline-flex items-center gap-2 font-bold px-8 py-3 rounded-xl transition-all text-sm shadow-lg hover:-translate-y-0.5"
            style={{
