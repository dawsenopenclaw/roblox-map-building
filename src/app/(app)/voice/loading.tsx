  ...
  return (
    <>
      ...
      <div className="loading-enter max-w-3xl mx-auto space-y-8">
        ...
        {/* Mic button area */}
        <div className="bg-[#141414] border border-white/10 rounded-2xl p-8 flex flex-col items-center gap-6">
          {/* Mic button circle */}
        ...
        <div className="space-y-3">
          ...
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="bg-[#141414] border border-white/10 rounded-xl px-5 py-4">
