      ...
      <div className="loading-enter max-w-7xl mx-auto px-4 sm:px-0">
        ...
        <div className="flex gap-2 mb-6">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="h-9 w-20 rounded-lg shimmer" />
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-[#141414] border border-white/10 rounded-2xl p-6">
              ...
              <div className="w-full h-72 rounded-xl shimmer" />
            </div>
          ...
          <div className="space-y-4">
                ...
                {Array.from({ length: 5 }).map((_, i) => (
                  <div key={i} className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="h-3 w-24 rounded-md shimmer mb-1" />
            ...
            <div className="bg-[#141414] border border-white/10 rounded-2xl p-5">
              ...
              <div className="space-y-3">
                {Array.from({ length: 3 }).map((_, i) => (
                  <div key={i}>
                    <div className="h-3 w-full rounded-md shimmer mb-2" />
