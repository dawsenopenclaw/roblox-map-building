    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="bg-[#141414] border border-white/10 rounded-2xl p-6">
        ...
        <button
          ...
          className="bg-[#D4AF37] hover:bg-[#E5A619] disabled:bg-[#D4AF37]/30 disabled:cursor-not-allowed text-black font-semibold px-6 py-2.5 rounded-xl transition-colors text-sm"
        >
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/5">
                    ...
                    <th className="text-left px-5 py-3 text-xs text-[#D4AF37] font-medium">
                      {scanA!.gameName || 'Game A'}
                    </th>
      ...
      {!canCompare && !loading && (
        <div className="bg-[#141414] border border-dashed border-white/10 rounded-2xl p-12 text-center">
          <div className="flex items-center justify-center gap-3 mb-5">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[#D4AF37]/10 border border-[#D4AF37]/20">
          ...
          {scans.length < 2 && (
            <p className="text-gray-500 text-xs mt-2">
              ...
              <Link href="/editor" className="text-[#D4AF37] hover:underline">
                Scan more games
              </Link>
            </p>
          )}
