...
export function EditorClient() {
  ...
  return (
    <div className="flex h-screen bg-[#080B1E] overflow-hidden" style={{ height: '100dvh' }}>
      ...
      {/* ── Icon bar ─────────────────────────────────────────────────────── */}
      <div className="flex flex-col items-center gap-1 py-3 px-1 bg-[#0A0E1F] border-r border-white/8 w-14 flex-shrink-0">
        {/* Home */}
        <Link
          href="/"
          title="Home"
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {/* Viewport — 60% height on desktop, top half on mobile */}
        <div className="flex-[3] flex flex-col md:flex-[6] min-h-0">
        ...
        <div className="flex-[4] flex flex-col min-h-0 bg-[#0A0E1F] md:flex-[4]">
          ...
          <div className="flex items-center justify-between px-4 py-2 border-b border-white/8 flex-shrink-0">
            ...
            <span className="text-[10px] text-gray-600">{totalTokens} tokens used</span>
          </div>
