...
export async function GET(req: NextRequest) {
  ...
  const body: Record<string, unknown> = {
    ...
    serverTime:    Date.now(),
    camera:        (session as unknown as Record<string, unknown>).camera ?? null,
    partCount:     (session as unknown as Record<string, unknown>).partCount ?? 0,
    modelCount:    (session as unknown as Record<string, unknown>).modelCount ?? 0,
    lightCount:    (session as unknown as Record<string, unknown>).lightCount ?? 0,
    nearbyParts:   (session as unknown as Record<string, unknown>).nearbyParts ?? [],
    selected:      (session as unknown as Record<string, unknown>).selected ?? [],
    sceneTree:     (session as unknown as Record<string, unknown>).sceneTree ?? [],
    groundY:       (session as unknown as Record<string, unknown>).groundY ?? 0,
  }
