...
export default function DocsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#060918]">
      {/* Header */}
      <div className="border-b border-white/10 bg-[#060918]/80 backdrop-blur-xl sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center gap-4">
          <a href="/" className="text-[#FFB81C] font-bold text-xl">RobloxForge</a>
        ...
        <main className="flex-1 min-w-0">
          ...
          <section className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              <span
                className={`text-xs font-bold px-2.5 py-1 rounded border ${methodColor[endpoint.method as keyof typeof methodColor] ?? 'text-gray-400 bg-white/5 border-white/10'}`}
              >
                {endpoint.method}
              </span>
            ...
            <pre className="bg-[#0D1231] border border-white/10 rounded-2xl p-6 text-sm text-gray-300 font-mono overflow-x-auto mb-6">
              {codeExample(lang, endpoint)}
            </pre>
            ...
            <div className="bg-[#0D1231] border border-[#FFB81C]/20 rounded-2xl p-6">
              <h3 className="text-[#FFB81C] font-semibold mb-4">Try it live</h3>
