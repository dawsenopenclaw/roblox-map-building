  ...
  return (
    <>
      ...
      >
        ...
        {/* ══════════════════════════════════════════════════════════════════
            AGENT ARSENAL — hype showcase, right after hero
        ══════════════════════════════════════════════════════════════════ */}
        <div className="section-divider" />

        <section
          className="relative py-28 px-6 overflow-hidden"
          style={{ background: 'linear-gradient(to bottom, #050810, #0A0F1E, #050810)' }}
        >
          {/* Multi-layer hype glow */}
          <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
            <div style={{
              position: 'absolute', inset: 0,
              background: [
          ...
          <style>{`
            ...
            @keyframes arsenal-count-up {
              0% { opacity: 0; transform: translateY(20px) scale(0.9); }
              100% { opacity: 1; transform: translateY(0) scale(1); }
            }
            .arsenal-ring {
              animation: arsenal-pulse 3s ease-in-out infinite;
            }
            .arsenal-ring-2 {
              animation: arsenal-pulse 3s ease-in-out infinite;
              animation-delay: 1s;
          ...
          <div className="relative max-w-6xl mx-auto">
            {/* Hype header — big number, bold claim */}
            <div className="text-center mb-16">
              ...
              <motion.div
                className="flex flex-wrap justify-center gap-4 text-[13px] font-semibold mb-2"
                initial={{ opacity: 0, y: 10 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                {[
                  { label: 'Build agents', count: 80, color: '#D4AF37' },
                  { label: 'Analyze agents', count: 20, color: '#818CF8' },
                  { label: 'Optimize agents', count: 16, color: '#10B981' },
                  { label: 'Growth agents', count: 28, color: '#F59E0B' },
                ].map(({ label, count, color }) => (
                  <span key={label} className="flex items-center gap-2 px-4 py-2 rounded-full" style={{
                    background: `${color}10`,
        ...
        {/* ══════════════════════════════════════════════════════════════════
            AI LIVE DEMO — iMessage-style chat showcase
        ══════════════════════════════════════════════════════════════════ */}
        <div className="section-divider" />
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div className="reveal reveal-delay-2 grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-4xl mx-auto">
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(135deg, rgba(99,102,241,0.3), rgba(212,175,55,0.3))',
                }}
              >
                <div
                  className="rounded-[14px] p-6 h-full"
                  style={{
