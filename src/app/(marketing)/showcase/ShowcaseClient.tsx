...
export default function ShowcaseClient() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      ...
      <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Showcase</h1>
      <p className="text-gray-400 max-w-md mb-8">
        See what creators are building with ForjeGames.
      </p>
      <Link href="/" className="text-sm font-semibold text-[#FFB81C] hover:text-[#FFD966] transition-colors">
        ← Back to Home
      </Link>
    </div>
  )
