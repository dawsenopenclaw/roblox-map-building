  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="text-center mb-12">
        <div className="h-12 w-96 max-w-full rounded-2xl shimmer mx-auto mb-4" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
        {Array.from({ length: 4 }).map((_, i) => (
          ...
          >
            ...
            {/* Price */}
            <div className="mb-6">
              <div className="h-10 w-24 rounded-xl shimmer mb-1" />
      ...
      <div className="bg-[#0D1231] border border-white/10 rounded-2xl p-8 max-w-2xl mx-auto mb-20">
        <div className="h-7 w-72 rounded-xl shimmer mx-auto mb-2" />
        ...
        <div className="bg-[#111640] rounded-xl p-5 mb-6 flex items-center justify-between gap-4">
          <div>
            ...
            <div className="h-8 w-20 rounded-xl shimmer mb-1" />
      ...
      <div className="mb-20">
        <div className="h-7 w-56 rounded-xl shimmer mx-auto mb-8" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="bg-[#0D1231] border border-white/10 rounded-2xl p-6 text-center">
            ...
            <div className="h-5 w-32 rounded-lg shimmer mx-auto mb-2" />
            <div className="h-4 w-full rounded-md shimmer mb-1" />
