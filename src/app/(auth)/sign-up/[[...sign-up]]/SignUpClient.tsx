...
const clerkAppearance = {
  ...
  elements: {
    ...
    formFieldInput: '!bg-[#1a1a1c] !border !border-white/[0.08] !text-white !rounded-lg !h-10 focus:!border-[#D4AF37] focus:!ring-1 focus:!ring-[#D4AF37]/20 !transition-colors',
    formButtonPrimary: '!bg-[#D4AF37] hover:!bg-[#E6A619] !text-black !font-semibold !rounded-lg !h-10 !shadow-none !transition-colors',
