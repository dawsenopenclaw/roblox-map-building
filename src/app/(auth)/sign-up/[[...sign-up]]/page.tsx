...
function DemoSignUp() {
  ...
  return (
    <div className="w-full">
      ...
      <p className="text-sm mb-8" style={{ color: '#A1A1AA' }}>Start building Roblox games with AI</p>
...
export default function SignUpPage() {
  ...
  return (
    <div className="w-full">
      ...
      <h1 className="text-2xl font-bold text-white tracking-tight mb-1">Create your account</h1>
      <p className="text-sm mb-7" style={{ color: '#A1A1AA' }}>Start building Roblox games with AI</p>
