      ...
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
        <div className="max-w-md w-full text-center">
          <div className="bg-[#141414] border border-white/10 rounded-xl p-8 shadow-xl">
            ...
            <p className="text-gray-400 text-xs mt-4">The link expires in 48 hours. Your account will be unlocked once they approve.</p>
          </div>
        </div>
      </div>
    )
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-[#1a1f3e] border border-white/20 text-white rounded-lg px-4 py-3 focus:outline-none focus:border-blue-400 transition-colors placeholder-gray-600"
              />
            </div>
