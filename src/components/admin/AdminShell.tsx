...
export function AdminShell({
  ...
  return (
    <div className="flex min-h-screen bg-[#0a0a0a]">
      ...
      >
        {/* Logo */}
        <div className="h-16 flex items-center gap-2 px-5 border-b border-[#1c1c1c]">
      ...
      <div className="flex-1 flex flex-col min-w-0 lg:ml-0">
        {/* Top bar (mobile) */}
        <header className="h-14 flex items-center gap-3 px-4 border-b border-[#1c1c1c] bg-[#141414] lg:hidden">
          <button
