...
const VARIANTS: Record<EmptyStateVariant, VariantConfig> = {
  no_projects: {
    ...
    description: 'Create your first Roblox map project and let AI build it for you.',
    cta: 'New project',
  },
  no_templates: {
    icon: (
    ...
    description: 'Templates you save will appear here for quick re-use.',
  ...
  no_activity: {
    ...
    description: 'Recent builds, scans, and exports will show up here.',
    cta: 'Start building',
  },
  no_team: {
    icon: (
    ...
    description: 'Invite collaborators to build maps together.',
    cta: 'Invite team',
  },
  no_scans: {
    icon: (
    ...
    title: 'No scans yet',
    description: 'Upload an image or describe a scene to generate your first map scan.',
    cta: 'New scan',
  },
}
  ...
  return (
    ...
    >
      ...
      <div className="relative mb-6">
        ...
        <div className="relative w-20 h-20 rounded-full bg-[#0D1231] border border-[#FFB81C]/20 flex items-center justify-center">
      ...
      {onCta && (
        <button
          onClick={onCta}
          className="bg-[#FFB81C] hover:bg-[#E6A519] text-black font-bold px-6 py-2.5 rounded-xl transition-colors text-sm"
        >
          {ctaLabel ?? config.cta}
        </button>
      )}
