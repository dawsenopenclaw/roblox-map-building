    ...
    >
      ...
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-3">
          {/* Mini icon */}
          <div className="w-10 h-10 rounded-xl bg-[#0a0a0a] border border-white/10 flex items-center justify-center flex-shrink-0">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#F5A623] text-[#0a0a0a] text-sm font-semibold hover:bg-[#F5A623]/90 transition-colors"
        >
