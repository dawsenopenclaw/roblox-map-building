...
const cspDirectives = [
  ...
  "img-src 'self' data: blob: https://img.clerk.com https://images.clerk.dev https://*.rbxcdn.com https://thumbnails.roblox.com https://www.roblox.com https://*.amazonaws.com https://*.r2.dev https://assets.meshy.ai",
